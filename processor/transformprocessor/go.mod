module github.com/andresousafd/opentelemetry-collector-contrib/processor/transformprocessor
...
require (
	...
	github.com/andresousafd/opentelemetry-collector-contrib/internal/pdatautil v0.127.0
