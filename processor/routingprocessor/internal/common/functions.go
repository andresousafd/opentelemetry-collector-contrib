...
package common // import "github.com/andresousafd/opentelemetry-collector-contrib/processor/routingprocessor/internal/common"
...
func Functions[K any]() map[string]ottl.Factory[K] {
	return ottl.CreateFactoryMap(
		...
		////github.com/andresousafd/opentelemetry-collector-contrib/issues/13545
