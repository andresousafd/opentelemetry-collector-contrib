...
import (
	...
	"github.com/andresousafd/opentelemetry-collector-contrib/receiver/postgresqlreceiver/internal/metadata"
)

const (
	readmeURL            = "https://github.com/andresousafd/opentelemetry-collector-contrib/blob/v0.88.0/receiver/postgresqlreceiver/README.md"
...
var separateSchemaAttrGate = featuregate.GlobalRegistry().MustRegister(
	...
	featuregate.WithRegisterReferenceURL("https://github.com/andresousafd/opentelemetry-collector-contrib/issues/29559"),
)
