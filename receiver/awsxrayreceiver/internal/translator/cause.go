...
func addCause(seg *awsxray.Segment, span ptrace.Span) {
	...
	case awsxray.CauseTypeExceptionID:
		...
		// https://github.com/andresousafd/opentelemetry-collector-contrib/blob/c615d2db351929b99e46f7b427f39c12afe15b54/exporter/awsxrayexporter/translator/cause.go#L107
