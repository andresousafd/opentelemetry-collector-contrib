...
issue](https://github.com/andresousafd/opentelemetry-collector-contrib/issues/new?assignees=&labels=Sponsor+Needed%2Cneeds+triage&projects=&template=new_component.yaml&title=New+component%3A+)
...
package fooreceiver // import "github.com/andresousafd/opentelemetry-collector-contrib/receiver/fooreceiver"
```
