...
func Meter(settings component.TelemetrySettings) metric.Meter {
	return settings.MeterProvider.Meter("github.com/andresousafd/opentelemetry-collector-contrib/pkg/stanza/fileconsumer")
}

func Tracer(settings component.TelemetrySettings) trace.Tracer {
	return settings.TracerProvider.Tracer("github.com/andresousafd/opentelemetry-collector-contrib/pkg/stanza/fileconsumer")
}
