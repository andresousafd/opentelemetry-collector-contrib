...
package prometheus // import "github.com/andresousafd/opentelemetry-collector-contrib/pkg/translator/prometheus"
...
var normalizeNameGate = featuregate.GlobalRegistry().MustRegister(
	...
	featuregate.WithRegisterReferenceURL("https://github.com/andresousafd/opentelemetry-collector-contrib/issues/8950"),
)
...
func normalizeName(metric pmetric.Metric, namespace string) string {
	...
	// See https://github.com/andresousafd/opentelemetry-collector-contrib/issues?q=is%3Aissue+some+metric+units+don%27t+follow+otel+semantic+conventions
