...
MOD_NAME=github.com/andresousafd/opentelemetry-collector-contrib
...
gencodecov: $(CODECOVGEN)
	$(CODECOVGEN) --base-prefix github.com/andresousafd/opentelemetry-collector-contrib --skipped-modules **/*test,**/examples/**,pkg/**,cmd/**,internal/**,*/encoding/**
