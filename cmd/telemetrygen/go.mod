module github.com/andresousafd/opentelemetry-collector-contrib/cmd/telemetrygen
...
// See https://github.com/andresousafd/opentelemetry-collector-contrib/issues/27855.
