...
package k8s // import "github.com/andresousafd/opentelemetry-collector-contrib/internal/datadog/hostmetadata/internal/k8s"
...
func (p *nodeNameProviderImpl) NodeName(ctx context.Context) (string, error) {
	...
	// https://github.com/andresousafd/opentelemetry-collector-contrib/issues/11033
