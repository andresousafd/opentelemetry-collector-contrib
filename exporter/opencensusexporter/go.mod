module github.com/andresousafd/opentelemetry-collector-contrib/exporter/opencensusexporter
...
require (
	...
	github.com/andresousafd/opentelemetry-collector-contrib/pkg/translator/opencensus v0.127.0
