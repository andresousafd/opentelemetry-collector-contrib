...
import (
	...
	"github.com/andresousafd/opentelemetry-collector-contrib/extension/jaegerremotesampling/internal/metadata"
...
func logDeprecation(logger *zap.Logger) {
	once.Do(func() {
		logger.Warn("jaegerremotesampling extension will deprecate Thrift-gen and replace it with Proto-gen to be compatible with jaeger 1.42.0 and higher. See https://github.com/andresousafd/opentelemetry-collector-contrib/pull/18485 for more details.")
	})
}
