module github.com/andresousafd/opentelemetry-collector-contrib/extension/observer/dockerobserver
...
require (
	...
	github.com/andresousafd/opentelemetry-collector-contrib/internal/docker v0.127.0
