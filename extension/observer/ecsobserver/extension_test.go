...
import (
	...
	"github.com/andresousafd/opentelemetry-collector-contrib/extension/observer/ecsobserver/internal/ecsmock"
)
...
func TestExtensionStartStop(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("skipping flaky test on Windows, see " +
			"https://github.com/andresousafd/opentelemetry-collector-contrib/issues/4042")
	}
